const socials = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="h-4 w-4" aria-hidden="true" fill="currentColor">
        <path d="M4.98 3.5C3.34 3.5 2 4.84 2 6.48s1.34 2.98 2.98 2.98 2.98-1.34 2.98-2.98S6.62 3.5 4.98 3.5Zm.02 4.94H2V21h3V8.44Zm7.5 0H9.5V21h3v-6.39c0-3.32 4.25-3.58 4.25 0V21h3v-7.86c0-5.17-5.56-4.99-7.75-2.44V8.44Z" />
      </svg>
    ),
  },
  {
    ...
    <div className={className}>
      ...
      <ul className="mt-3 flex flex-wrap gap-3 text-sm text-slate-300">
        {socials.map((social) => (
          <li key={social.label}>
            <a
              className="inline-flex items-center gap-2 hover:text-accent-soft"
              href={social.href}
              target="_blank"
              rel="noreferrer"
            >
